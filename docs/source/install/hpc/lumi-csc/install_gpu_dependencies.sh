...
# Check: ######################################################################
#
#   Was lumi_gpu_impactx.profile sourced and configured correctly?
if [ -z ${proj-} ]; then echo "WARNING: The 'proj' variable is not yet set in your lumi_gpu_impactx.profile file! Please edit its line 2 to continue!"; exit 1; fi
...
cmake -S ${SRC_DIR}/adios2             \
      ...
      -DCMAKE_INSTALL_PREFIX=${SW_DIR}/adios2-2.8.3
