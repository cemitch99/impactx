...
man_pages = [(master_doc, "impactx", "ImpactX Documentation", [author], 1)]
...
breathe_projects = {"ImpactX": "../doxyxml/"}
breathe_default_project = "ImpactX"
...
download_with_headers(
    ...
    filename="../warpx-doxygen-web.tag.xml",
)
download_with_headers(
