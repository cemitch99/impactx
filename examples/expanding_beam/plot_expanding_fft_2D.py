...
plt.ylabel("transverse beam size (mm)", fontsize=25)
plt.xticks(fontsize=20)
plt.yticks(fontsize=20)
plt.grid(True)

# Plot the data
plt.plot(s, sigma_x, "b", label="Horizontal", linewidth=2, linestyle="solid")

plt.plot(s, sigma_y, "r", label="Vertical", linewidth=2, linestyle="solid")
